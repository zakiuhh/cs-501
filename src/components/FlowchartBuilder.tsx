  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid md:grid-cols-12 gap-5 items-start">
        ...
        <div className="md:col-span-7 bg-surface-card border border-hairline rounded-xl p-4 md:p-5 md:max-h-[calc(100vh-220px)] md:overflow-y-auto pr-1.5 custom-scrollbar md:sticky md:top-[160px] self-start">
